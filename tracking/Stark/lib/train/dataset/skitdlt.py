...
class SkiTDLT(BaseVideoDataset):
    """ LaSOT dataset.
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, vid_ids=None, split=None, data_fraction=None, disciplines=['AL', 'JP', 'FS'], split_mode='date'):
        ...
        super().__init__('SkiTDLT', root, image_loader)
        ...
        for discipline_id in self.disciplines:
            ...
            if discipline_id == 'AL':
                ...
                for i, test_seq in enumerate(vid_names):
                    if os.path.exists(os.path.join(self.root, 'AL', test_seq, 'LT')):
                        valid_idxs.append(i)
    ...
    def _get_sequence_path(self, seq_id):
        ...
        return os.path.join(self.root, disc_id, seq_name, 'LT')
